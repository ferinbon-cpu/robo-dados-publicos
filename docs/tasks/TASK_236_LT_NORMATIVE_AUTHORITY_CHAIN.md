...
2. **Deliberação Conjunta CME/SME nº 001, de 28/10/2025** — Jornal Oficial edição 7107, 30/10/2025.
   ...
   - O texto exato do art. 8º **não é reconstruído** nesta task.
...
- o texto exato do art. 8º da Deliberação 001;
...
A TASK 236 **mantém a divergência aberta**. A cadeia institucional de LT, por si só, não resolve a diferença. A resolução exige localizar ato oficial posterior com texto exato que modifique ou esclareça o prazo.
