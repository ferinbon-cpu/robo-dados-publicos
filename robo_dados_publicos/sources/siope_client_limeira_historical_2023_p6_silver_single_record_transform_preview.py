...
ERROR = "STOP_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2023_P6_SILVER_SINGLE_RECORD_TRANSFORM_PREVIEW"
PASS = "PASS_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2023_P6_SILVER_SINGLE_RECORD_TRANSFORM_PREVIEW"


class Historical2023P6SilverTransformPreviewError(RuntimeError):
    pass
...
def load_json(path: str | Path) -> dict:
    ...
    if not isinstance(payload, dict):
        raise Historical2023P6SilverTransformPreviewError(f"{ERROR}_OBJECT_REQUIRED")
    return payload


def _require(actual, expected, code: str) -> None:
    if actual != expected:
        raise Historical2023P6SilverTransformPreviewError(f"{ERROR}_{code}")
...
def validate_config(config: dict) -> dict:
    _require(config.get("gate_id"), "M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2023_P6_SILVER_SINGLE_RECORD_TRANSFORM_PREVIEW_0_8_0", "GATE")
    ...
    _require(config.get("readback_review_gate"), "M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2023_P6_BRONZE_DRIVE_READBACK_REVIEW_0_8_0", "REVIEW_GATE")
    ...
    _require(config.get("record_sha256"), "8b63fd15413c3ab9ca5f82749ea5d89e5a1c92b06e7b80cb6def7af60b769919", "RECORD_SHA")
    _require(config.get("source_bundle_sha256"), "929a999672343b0e423283dcbd8f1ba797f9f924cecaee00b70b37b312ec2dfc", "BUNDLE_SHA")
    ...
    _require(config.get("next_gate"), "M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2023_P6_SILVER_SINGLE_RECORD_TRANSFORM_REVIEW_0_8_0", "NEXT")
