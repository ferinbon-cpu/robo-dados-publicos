...
ERROR = "STOP_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_GOLD_TRANSFORM_PREVIEW"
PASS = "PASS_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_GOLD_TRANSFORM_PREVIEW"
...
def build_preview(config: dict, *, root: str | Path) -> tuple[dict, dict]:
    ...
    _require(data.get("NUM_ANO"), 2022, "YEAR")
