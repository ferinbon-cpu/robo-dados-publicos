...
ERROR = "STOP_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_SILVER_DRIVE_PERSISTENCE_REVIEW"
PASS = "PASS_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_SILVER_DRIVE_PERSISTENCE_REVIEW"


class Historical2022P6SilverDrivePersistenceReviewError(RuntimeError):
    pass
...
def load_json(path: str | Path) -> dict:
    ...
    if not isinstance(payload, dict):
        raise Historical2022P6SilverDrivePersistenceReviewError(f"{ERROR}_OBJECT_REQUIRED")
    return payload


def _require(actual, expected, code: str) -> None:
    if actual != expected:
        raise Historical2022P6SilverDrivePersistenceReviewError(f"{ERROR}_{code}")
...
def review(config: dict, *, root: str | Path) -> dict:
    expected_config = {
        ...
        "gate_id": "M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_SILVER_DRIVE_PERSISTENCE_REVIEW_0_8_0",
        "gold_authorized": False,
        "historical_collection_authorized": False,
        "mode": "OFFLINE_PINNED_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_SILVER_DRIVE_PERSISTENCE_REVIEW",
        "network_called": False,
        "next_gate": "M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_SILVER_DRIVE_READBACK_VERIFICATION_0_8_0",
        "pinned_artifact_digest": "sha256:f73fe06ff5dbf3674e2e6944b6b256ddbebdb2229668f08fb78cebf62dc31aff",
        "pinned_artifact_id": 9649057585,
        "pinned_evidence_blob_sha": "02cd74799ad32e3a20745cd37d47c82d669e3b1d",
        "pinned_evidence_path": "docs/evidence/M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_SILVER_DRIVE_PERSISTENCE_RUN_1_0.8.0.json",
        "pinned_head_sha": "3feff568e056e5b5fc9a4b402c3eee547daa14ff",
        "pinned_historical_regressions": 109,
        "pinned_job_id": 98539890652,
        "pinned_record_sha256": "79b786f438d29803fe15d513f4ff17d4ab55fde1dd631f503b6752370e21b68a",
        "pinned_remote_name": "FNDE_SIOPE_DADOS_INFORMADOS_MUNICIPIOS_LIMEIRA__Dados_Gerais_Siope__Limeira_SP__2022_P6__352690__d8f14e5fa52c__silver_v1.json",
        "pinned_run_id": 33078760226,
        "pinned_run_number": 1,
    ...
    expected_evidence = {
        ...
        "artifact_name": "siope-client-limeira-historical-2022-p6-silver-drive-persistence-33078760226",
        "drive_create_only": True,
        "drive_network_called": True,
        "drive_write_count": 1,
        "event": "workflow_dispatch",
        "gate_id": "M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_SILVER_DRIVE_PERSISTENCE_0_8_0",
        "gold_authorized": False,
        "head_branch": "main",
        ...
        "status": "PASS_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_SILVER_DRIVE_PERSISTENCE",
