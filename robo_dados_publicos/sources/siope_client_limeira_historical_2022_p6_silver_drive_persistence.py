...
ERROR = "STOP_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_SILVER_DRIVE_PERSISTENCE"
PASS = "PASS_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_SILVER_DRIVE_PERSISTENCE"
...
def _build_silver_payload(config: dict, *, root: str | Path) -> dict:
    ...
    _require(record.get("NUM_ANO"), 2022, "YEAR")
...
def validate_config(config: dict, *, root: str | Path) -> dict:
    expected = {
        ...
        "next_gate": "M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_SILVER_DRIVE_PERSISTENCE_REVIEW_0_8_0",
        ...
        "review_gate": "M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_SILVER_SINGLE_RECORD_TRANSFORM_REVIEW_0_8_0",
