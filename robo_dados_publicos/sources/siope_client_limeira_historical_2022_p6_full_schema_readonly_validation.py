...
ERROR = "STOP_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_FULL_SCHEMA_READONLY_VALIDATION"
PASS = "PASS_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_FULL_SCHEMA_READONLY_VALIDATION"


class SiopeClientLimeiraHistorical2022P6FullSchemaReadonlyValidationError(RuntimeError):
...
def _require(actual, expected, code: str) -> None:
    if actual != expected:
        raise SiopeClientLimeiraHistorical2022P6FullSchemaReadonlyValidationError(f"{ERROR}_{code}")
...
def _as_int(value, code: str) -> int:  # noqa: ANN001
    try:
        ...
        raise SiopeClientLimeiraHistorical2022P6FullSchemaReadonlyValidationError(
...
def validate_config(config: dict) -> dict:
    ...
    return {
        "status": "PASS_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_FULL_SCHEMA_READONLY_VALIDATION_DESIGN",
...
def run_validation(config: dict, *, opener=None) -> dict:
    ...
    if (
        ...
        or _as_int(record.get("NUM_ANO"), "YEAR_INVALID") != 2022
