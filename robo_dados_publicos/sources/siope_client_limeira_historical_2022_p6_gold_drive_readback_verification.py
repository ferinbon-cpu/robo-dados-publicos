...
ERROR = "STOP_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_GOLD_DRIVE_READBACK_VERIFICATION"
PASS = "PASS_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_GOLD_DRIVE_READBACK_VERIFICATION"
...
def validate_config(config: dict, *, root: str | Path) -> dict:
    expected = {
        ...
        "next_gate": "M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_GOLD_DRIVE_READBACK_REVIEW_0_8_0",
        "overwrite_authorized": False,
        "persistence_config_path": "config/source_expansion.siope_client_limeira_historical_2022_p6_gold_drive_persistence.json",
        ...
        "review_gate": "M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_GOLD_DRIVE_PERSISTENCE_REVIEW_0_8_0",
...
def verify_readback(config: dict, *, root: str | Path, drive=None) -> dict:
    ...
    with tempfile.TemporaryDirectory() as td:
        local = Path(td) / "historical_2022_p6_gold_readback.json"
