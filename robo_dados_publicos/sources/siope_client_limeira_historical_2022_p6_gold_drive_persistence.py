...
ERROR = "STOP_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_GOLD_DRIVE_PERSISTENCE"
PASS = "PASS_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_GOLD_DRIVE_PERSISTENCE"
...
def _validated_gold_payload(config: dict, *, root: str | Path) -> dict:
    ...
    try:
        ...
        _require(review_result.get("status"), "PASS_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_GOLD_TRANSFORM_REVIEW", "REVIEW_STATUS")
    ...
    _require(gold_payload.get("identity", {}).get("year"), 2022, "YEAR")
...
def validate_config(config: dict, *, root: str | Path) -> dict:
    expected = {
        ...
        "next_gate": "M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_GOLD_DRIVE_PERSISTENCE_REVIEW_0_8_0",
        ...
        "review_config_path": "config/source_expansion.siope_client_limeira_historical_2022_p6_gold_transform_review.json",
        "review_gate": "M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_GOLD_TRANSFORM_REVIEW_0_8_0",
...
def persist(config: dict, *, root: str | Path, drive=None) -> dict:
    ...
    with tempfile.TemporaryDirectory() as td:
        local = Path(td) / "historical_2022_p6_gold_payload.json"
