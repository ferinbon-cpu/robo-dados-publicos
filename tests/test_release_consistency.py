...
class TestReleaseConsistency(unittest.TestCase):
    ...
    def test_current_release_metadata_match(self):
        ...
        self.assertEqual('0.5.9', manifest['current_active'])
        self.assertEqual(__version__, manifest['current_candidate'])
        self.assertEqual('0.5.9', manifest['last_active_validated'])
        self.assertEqual('0.5.9', active_manifest['version'])
        ...
        self.assertEqual('0.5.9', preserved_candidate['version'])
        ...
        self.assertIn('**Software ativo:** 0.5.9 ACTIVE', readme)
    ...
    def test_candidate_release_identity_is_explicit(self):
        ...
        self.assertEqual('0.5.9', ACTIVE_VALIDATED_VERSION)
