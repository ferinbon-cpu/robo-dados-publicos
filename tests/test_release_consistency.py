...
class TestReleaseConsistency(unittest.TestCase):
    ...
    def test_current_release_metadata_match(self):
        ...
        self.assertEqual('0.6.1', manifest['current_active'])
        self.assertEqual(__version__, manifest['current_candidate'])
        self.assertEqual('0.6.1', manifest['last_active_validated'])
        self.assertEqual('0.6.1', active_manifest['version'])
        ...
        self.assertEqual('0.6.1', preserved_candidate_manifest['version'])
        ...
        self.assertIn('**Software ativo:** 0.6.1 ACTIVE', readme)
    ...
    def test_candidate_release_identity_is_explicit(self):
        ...
        self.assertEqual('0.6.1', ACTIVE_VALIDATED_VERSION)
