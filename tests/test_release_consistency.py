...
class TestReleaseConsistency(unittest.TestCase):
    ...
    def test_current_release_metadata_match(self):
        ...
        self.assertEqual(__version__, preserved_candidate_manifest['version'])
        ...
        self.assertEqual(__version__, active_qa['version'])
        ...
        self.assertIn('**Candidata corrente:** NONE', readme)
