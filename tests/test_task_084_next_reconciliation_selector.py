...
class TestTask084NextReconciliationSelector(unittest.TestCase):
    ...
    def test_real_task084_constants_are_pinned_by_repository_evidence(self):
        expected_plan_sha = "faf27576b5b2c3b3c542ae41eeac90c415da1d2f50b6ae8021e1c04bf246d7bc"
        consumed = "RECTASK_39a82b72abdffa19e0dba705"
        self.assertEqual(64, len(expected_plan_sha))
        self.assertTrue(consumed.startswith("RECTASK_"))
