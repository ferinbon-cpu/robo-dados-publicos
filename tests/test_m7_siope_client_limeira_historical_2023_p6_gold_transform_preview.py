...
from robo_dados_publicos.sources.siope_client_limeira_historical_2023_p6_gold_transform_preview import (
...
from robo_dados_publicos.sources.siope_client_limeira_historical_2023_p6_silver_drive_readback_review import (
...
REVIEW_CONFIG = ROOT / "config/source_expansion.siope_client_limeira_historical_2023_p6_silver_drive_readback_review.json"
GOLD_CONFIG = ROOT / "config/source_expansion.siope_client_limeira_historical_2023_p6_gold_transform_preview.json"
SILVER_PERSISTENCE_CONFIG = ROOT / "config/source_expansion.siope_client_limeira_historical_2023_p6_silver_drive_persistence.json"
WORKFLOW = ROOT / ".github/workflows/siope-client-limeira-historical-2023-p6-gold-transform-preview-gate.yml"


class HistoricalGoldTransformPreviewTests(unittest.TestCase):
    def test_readback_review_accepts_exact_pinned_success_and_blob(self):
        ...
        self.assertEqual(result["status"], "PASS_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2023_P6_SILVER_DRIVE_READBACK_REVIEW")
    ...
    def test_gold_design_is_offline_write_closed_and_no_compliance_claims(self):
        ...
        self.assertEqual(result["status"], "PASS_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2023_P6_GOLD_TRANSFORM_PREVIEW_DESIGN")
        self.assertFalse(result["network_called"])
    ...
    def test_exact_verified_historical_silver_builds_expected_gold(self):
        ...
        self.assertEqual(result["status"], "PASS_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2023_P6_GOLD_TRANSFORM_PREVIEW")
        self.assertEqual(result["metric_count"], 8)
        self.assertEqual(result["metrics"], {
            "receita_realizada_sobre_previsao_atualizada_pct": "93.1907",
            "despesa_paga_sobre_dotacao_atualizada_pct": "84.5841",
            "despesa_educacao_paga_sobre_dotacao_atualizada_educacao_pct": "90.5184",
            "participacao_educacao_na_despesa_empenhada_pct": "23.2779",
            "participacao_educacao_na_despesa_liquidada_pct": "24.0048",
            "participacao_educacao_na_despesa_paga_pct": "23.4830",
            "despesa_total_paga_por_habitante": "5569.40",
            "despesa_educacao_paga_por_habitante": "1307.86",
        })
        ...
        self.assertEqual(result["gold_payload_sha256"], "a4da994fd2a04ef0b3133d9a20855e6809922f19366075d48aab3296ca488272")
    ...
    def test_gate_scripts_run_directly_without_network(self):
        review_cp = subprocess.run(
            [sys.executable, "scripts/github_siope_client_limeira_historical_2023_p6_silver_drive_readback_review_gate.py"],
            cwd=ROOT,
            text=True,
            capture_output=True,
            check=False,
        ...
        dry_cp = subprocess.run(
            [sys.executable, "scripts/github_siope_client_limeira_historical_2023_p6_gold_transform_preview_gate.py", "--dry-run"],
            cwd=ROOT,
            text=True,
            capture_output=True,
            check=False,
        ...
        preview_cp = subprocess.run(
            [sys.executable, "scripts/github_siope_client_limeira_historical_2023_p6_gold_transform_preview_gate.py"],
            cwd=ROOT,
            text=True,
            capture_output=True,
            check=False,
    ...
    def test_workflow_is_manual_offline_full_qa_and_has_no_remote_write(self):
        ...
        self.assertIn("confirm_siope_client_limeira_historical_2023_p6_gold_transform_preview", text)
        self.assertIn("contents: read", text)
        self.assertNotIn("schedule:", text)
        self.assertIn("github_siope_client_limeira_historical_2023_p6_silver_drive_readback_review_gate.py", text)
        self.assertIn("github_siope_client_limeira_historical_2023_p6_gold_transform_preview_gate.py --dry-run", text)
