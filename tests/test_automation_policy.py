...
class TestAutomationPolicy(unittest.TestCase):
    ...
    def test_m8_no_click_is_blocked_until_readonly_credential_is_proven(self):
        ...
        self.assertIn("CURRENT_REFRESH_TOKEN_CAPABILITY_IS_NOT_PROVEN_READONLY", decision["blockers"])
    ...
    def test_current_m8_workflow_remains_manual_until_readonly_secret_is_wired(self):
        ...
        self.assertIn("GOOGLE_DRIVE_REFRESH_TOKEN", workflow)
        self.assertNotIn("GOOGLE_DRIVE_READONLY_REFRESH_TOKEN", workflow)
