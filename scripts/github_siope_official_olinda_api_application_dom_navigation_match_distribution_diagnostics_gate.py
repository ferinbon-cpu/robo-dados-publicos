...
from robo_dados_publicos.sources.siope_official_olinda_api_application_dom_navigation_match_distribution_diagnostics import (  # noqa: E402
...
from scripts.github_siope_official_olinda_api_application_dom_navigation_match_distribution_diagnostics_design_gate import run_gate as run_design_gate  # noqa: E402

CONFIG = ROOT / "config" / "source_expansion.siope_official_olinda_api_application_dom_navigation_match_distribution_diagnostics.json"
...
def run_gate(*, dry: bool = False) -> dict:
    ...
    return dry_run(config, design_result) if dry else run_navigation_match_distribution_diagnostics(config, design_result)
...
def main() -> int:
    ...
    try:
        ...
        exit_code = 0
    except SiopeOfficialOlindaApiApplicationDomNavigationMatchDistributionDiagnosticsError as exc:
        result = {
            "status": "STOP_M7_SIOPE_OFFICIAL_OLINDA_API_APPLICATION_DOM_NAVIGATION_MATCH_DISTRIBUTION_DIAGNOSTICS",
            "error_code": str(exc),
            **exc.diagnostics,
