...
from robo_dados_publicos.sources.siope_artifact_download_dom_intent_diagnostics import diagnose_artifact_download_dom_intent
...
def main() -> int:
    ...
    if args.dry_run:
        _emit(_safety("PASS_M7_SIOPE_ARTIFACT_DOWNLOAD_DOM_INTENT_DIAGNOSTICS_DRY_RUN"), args.output)
        return 0
    try:
        result = diagnose_artifact_download_dom_intent(config)
