...
def main() -> int:
    ...
    json_path = out_dir / "PLANNING_DOCUMENT_INDEX_TASK189.json"
    json_path.write_bytes(json_bytes)

    gzip_path = out_dir / "PLANNING_DOCUMENT_INDEX_TASK189.json.gz"
    ...
    manifest = {
        "schema": "TASK189_PLANNING_DOCUMENT_INDEX_MANIFEST_V1",
        ...
        "base_task184_rows": product["overlay_scope"]["base_task184_rows"],
        "task189_rows": product["overlay_scope"]["task189_rows"],
        "primary_substantive_document_types": ["LDO", "LOA", "PPA"],
    ...
    manifest_path = out_dir / "PLANNING_DOCUMENT_INDEX_TASK189.manifest.json"
