...
from robo_dados_publicos.sources.siope_official_olinda_api_application_loaded_script_syntax_skeleton_diagnostics_design import load_json, run_design

CONFIG = ROOT / "config/source_expansion.siope_official_olinda_api_application_loaded_script_syntax_skeleton_diagnostics_design.json"


def run_gate() -> dict:
    config = load_json(CONFIG)
    review_config = load_review_json(ROOT / config["locality_review_config_path"])
