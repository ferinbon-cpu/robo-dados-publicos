...
from robo_dados_publicos.sources.siope_client_limeira_historical_2022_p6_gold_drive_readback_verification import (  # noqa: E402
...
CONFIG = ROOT / "config/source_expansion.siope_client_limeira_historical_2022_p6_gold_drive_readback_verification.json"
...
def main() -> int:
    ...
    try:
        ...
        print(json.dumps({
            "status": "STOP_M7_SIOPE_CLIENT_LIMEIRA_HISTORICAL_2022_P6_GOLD_DRIVE_READBACK_VERIFICATION_UNEXPECTED",
