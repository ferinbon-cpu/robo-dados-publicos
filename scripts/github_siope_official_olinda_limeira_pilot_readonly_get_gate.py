...
from robo_dados_publicos.sources.siope_official_olinda_limeira_pilot_readonly_get import (  # noqa: E402
...
CONFIG = ROOT / "config/source_expansion.siope_official_olinda_limeira_pilot_readonly_get_design.json"
...
def main() -> int:
    ...
    if args.dry_run:
        ...
        return 0
    try:
        result = run_pilot_get(config)
    except SiopeOfficialOlindaLimeiraPilotReadonlyGetError as exc:
        _write(
            {
                "status": str(exc),
                ...
                "pilot_limeira_values_sent": bool(exc.network_called),
