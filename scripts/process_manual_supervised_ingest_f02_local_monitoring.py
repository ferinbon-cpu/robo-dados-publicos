...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Offline fail-closed F02 local-monitoring processor for periods without same-period RREO."
    )
    ...
    plan = load_f02_local_monitoring_plan(args.config)
    paths = {
    ...
    reference = plan["raw"]["reference_period"]
    ...
    core = {
        ...
        "official_period_context": plan["raw"]["official_period_context"],
        ...
        "status": "PASS_F02_LOCAL_MONITORING_OFFLINE_SILVER_CANDIDATE_NOT_PROMOTED",
    }
