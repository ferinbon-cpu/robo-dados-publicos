...
from robo_dados_publicos.sources.siope_official_olinda_api_application_loaded_script_syntax_skeleton_diagnostics_review import load_json as load_review_json, run_review
from robo_dados_publicos.sources.siope_official_olinda_api_application_dom_syntax_skeleton_diagnostics_design import load_json as load_design_json, run_design
...
def main() -> int:
    ...
    try:
        ...
        exit_code = 0
    except SiopeOfficialOlindaApiApplicationDomSyntaxSkeletonDiagnosticsError as exc:
        result = {
            "status": "STOP_M7_SIOPE_OFFICIAL_OLINDA_API_APPLICATION_DOM_SYNTAX_SKELETON_DIAGNOSTICS",
            "error_code": str(exc),
            **exc.diagnostics,
