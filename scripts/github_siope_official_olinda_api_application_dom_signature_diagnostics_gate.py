...
from robo_dados_publicos.sources.siope_official_olinda_api_application_dom_signature_diagnostics import (  # noqa: E402
    SiopeOfficialOlindaApiApplicationDomSignatureDiagnosticsError,
    dry_run,
    load_json,
    run_dom_signature_diagnostics,
)
from scripts.github_siope_official_olinda_api_application_dom_signature_diagnostics_design_gate import run_gate as run_design_gate  # noqa: E402
...
def run_gate(*, dry: bool = False) -> dict:
    ...
    return dry_run(config, design_result) if dry else run_dom_signature_diagnostics(config, design_result)
...
def main() -> int:
    ...
    try:
        ...
        exit_code = 0
    except SiopeOfficialOlindaApiApplicationDomSignatureDiagnosticsError as exc:
        result = {
            "status": "STOP_M7_SIOPE_OFFICIAL_OLINDA_API_APPLICATION_DOM_SIGNATURE_DIAGNOSTICS",
            "error_code": str(exc),
            **exc.diagnostics,
